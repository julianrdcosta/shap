...
class Asymmetric(Explainer):
    ...
    def __init__(self, model, masker, link=links.identity, feature_names=None, linearize_link=True, **call_args):
        ...
        **call_args : valid argument to the __call__ method
        ...
        if len(call_args) > 0:
            ...
            class Asymmetric(self.__class__):
            ...
            Asymmetric.__call__.__doc__ = self.__class__.__call__.__doc__
            self.__class__ = Asymmetric
    ...
    def explain_row(self, *row_args, max_evals, main_effects, error_bounds, batch_size, outputs, silent):
        ...
        #inds = fm.varying_inputs() #changed this because i want all the features because the permutations need it
        inds = np.arange(fm._masker_cols)
